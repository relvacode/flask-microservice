...
EXPOSE 80
WORKDIR /app
ENV S6_BEHAVIOUR_IF_STAGE2_FAILS=2 DEBIAN_FRONTEND=noninteractive
ENV UWSGI_ENTRYPOINT=api UWSGI_APPLICATION=app UWSGI_CACHE_SIZE=1000 UWSGI_CACHE_BLOCKSIZE=4096
